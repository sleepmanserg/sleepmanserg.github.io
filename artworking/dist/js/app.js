 ...
 */
    ...
    (() => {
        ...
        function menuInit() {
            ...
            if (document.querySelector(".header-menu--btn")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".header-menu--btn")) {
                    bodyLockToggle();
                ...
                if (bodyLockStatus && !e.target.closest("#nav-content") && document.documentElement.classList.contains("menu-open")) {
                    toggle.setAttribute("aria-expanded", false);
                    content.setAttribute("aria-hidden", true);
                    functions_menuClose();
                }
