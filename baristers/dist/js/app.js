    ...
    (() => {
        ...
        function menuInit() {
            ...
            window.addEventListener("resize", (() => {
                if (window.innerWidth > 1024.98) functions_menuClose();
            }));
        }
        ...
        function materialInputs() {
            ...
            inputList.forEach((function(elem) {
                ...
                elem.addEventListener("focus", (e => {
                    ...
                    if (elem.classList.contains("validate")) {
                        if (null !== elem.value) if (elem.checkValidity()) {
                            elem.classList.add("valid");
                            label.classList.add("valid");
                        } else {
                            elem.classList.remove("valid");
                ...
                elem.addEventListener("blur", (e => {
                    ...
                    if (elem.classList.contains("validate")) if (null !== elem.value) {
                        elem.classList.remove("valid");
                        elem.classList.remove("invalid");
                    }
                }));
            ...
            if (document.querySelector(".swiper")) {
                ...
                const breakpointChecker = function() {
                    if (true === breakpoint.matches) {
                        if (void 0 !== achievementSlider) achievementSlider.destroy(true, true);
                        return;
        ...
        function headerScroll() {
            ...
            document.addEventListener("windowScroll", (function(e) {
                ...
                if (scrollTop >= startPoint) {
                    ...
                    if (headerShow) {
                        if (!scrollTop > scrollDirection) !header.classList.contains("_header-show") ? header.classList.add("_header-show") : null;
                        timer = setTimeout((() => {
