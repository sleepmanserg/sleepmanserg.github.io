...
<<<<<<< HEAD:src/js/files/functions.js
/* Dropdown toggle */
	...
	radioButtons.forEach(radioButton => {
		...
		radioButton.addEventListener('change', function (e) {
			if (radioButton.checked) {
				productPrice.innerHTML = radioButton.value;
			}
		});
...
=======
>>>>>>> refs/remotes/origin/main:baristers/src/js/files/functions.js
